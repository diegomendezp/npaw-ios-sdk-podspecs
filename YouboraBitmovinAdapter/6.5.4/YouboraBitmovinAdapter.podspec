Pod::Spec.new do |s|
  ...
  # Source files
  s.source_files = 'YouboraBitmovinAdapter/**/*.{h,m}'

  s.public_header_files = "YouboraBitmovinAdapter/**/*.h"

  # Project settings
  s.pod_target_xcconfig = { 'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) YOUBORABITMOVINADAPTER_VERSION_SETTING=' + s.version.to_s }

  # Dependency
  s.dependency 'BitmovinPlayer', '~> 2.41.0'
